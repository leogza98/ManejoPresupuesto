...
namespace ManejoPresupuesto.Servicios
{
    public interface IRepositoriosTransacciones
    {
        ...
        Task<IEnumerable<Transaccion>> ObtenerPorId(ObtenerTransaccionesPorCuenta modelo);
    }

    public class RepositorioTransacciones : IRepositoriosTransacciones
    {
        ...
        public async Task<IEnumerable<Transaccion>> ObtenerPorId (ObtenerTransaccionesPorCuenta modelo)
        {
            using var connection = new SqlConnection(connectionString);
